...
public final class FlowDataType {
    ...
    public static final FlowDataType RESOURCE_REFERENCE = new FlowDataType("resource_reference", null, 0x5CC8FF, "Resource Reference");
    public static final FlowDataType RESULT = new FlowDataType("result", null, 0x55D68A, "Result");
    public static final FlowDataType JOB_REFERENCE = new FlowDataType("job_reference", null, 0xFFB347, "Job Reference");
    public static final FlowDataType SCHEDULED_TASK = new FlowDataType("scheduled_task", null, 0x7AA2F7, "Scheduled Task");
    public static final FlowDataType GUI_DEFINITION = new FlowDataType("gui_definition", null, 0x4FA3FF, "GUI Definition");
    public static final FlowDataType SCOREBOARD_DEFINITION = new FlowDataType("scoreboard_definition", null, 0x3E8BFF, "Scoreboard Definition");
    public static final FlowDataType TAB_DEFINITION = new FlowDataType("tab_definition", null, 0x61B5FF, "Tab Definition");
    ...
    public static final FlowDataType DIALOG_DEFINITION = new FlowDataType("dialog_definition", null, 0xC274FF, "Dialog Definition");
    ...
    public static final FlowDataType NPC_DEFINITION = new FlowDataType("npc_definition", null, 0xBF7A4A, "NPC Definition");
    ...
    public static final FlowDataType GUI_SESSION = new FlowDataType("gui_session", RESOURCE_REFERENCE, 0x348CDD, "GUI Session");
    ...
    public static final FlowDataType SIDEBAR_SESSION = new FlowDataType("sidebar_session", RESOURCE_REFERENCE, 0x3479D3, "Sidebar Session");
    ...
    public static final FlowDataType NPC_HANDLE = new FlowDataType("npc_handle", null, 0xA96437, "NPC Handle");
